...
<!-- Swiper -->
	...
	<div class="swiper-container" id="swiper4">
        <div class="swiper-wrapper">
            <div class="swiper-slide"><a href="<%=companyurl_db(49)%>"><img src="images/banner4-1.jpg" alt=""></a></div>                   
