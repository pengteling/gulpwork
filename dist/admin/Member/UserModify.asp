    ...
    <td width="862" align="center" valign="top"> 
      <FORM name="Form1" action="UserModify.asp" method="post">
        <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="ECF5FF" class="table_southidc">
          ...
          <TR class="tdbg" > 
            <TD align="right" class="tr_southidc"><strong>固定电话：</strong><br></TD>
          ...
          <TR class="tdbg" > 
            <TD width="120" align="right" class="tr_southidc"><strong>用户类别：</strong></TD>
            <TD class="tr_southidc"><select name="IsTJ" id="IsTJ">
              <option value="0" <%if rsUser("IsTJ")=0 then response.write "selected"%> >普通会员</option>
              <option value="1" <%if rsUser("IsTJ")=1 then response.write "selected"%>>VIP会员</option>
            </select></TD>
          </TR>
          <TR class="tdbg" > 
