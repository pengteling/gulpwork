...
price=strToNum(Request("price"))
price_yuan=strToNum(Request("price_yuan"))
price_now=strToNum(Request("price_now"))

pinming=ChkFormStr(request.form("pinming"))
chandi=ChkFormStr(request.form("chandi"))
guige=(request.form("guige"))
pingji=(request.form("pingji"))
productNo=ChkFormStr(request.form("productNo"))
...
If lcase(Request("Act"))="add" Then
	Call p_cate(cateid,2)
		...
		rs("price")=price
		rs("price_yuan")=price_yuan
		rs("price_now")=price_now
