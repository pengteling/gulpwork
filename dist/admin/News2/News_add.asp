...
<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" class="table_southidc">
  <form name="myform" method="post" action="News_save.asp" onSubmit="return CheckForm();">
   ...
   <!--  <tr bgcolor="#ECF5FF">
     ...
     <td colspan="2" width="80%"><input name="productNo" type="text" class="input" size="20"></td>
   </tr> -->
...
<textarea id="guigeid" name="guige"  style="width:700px;height:500px;visibility:hidden;"></textarea>

    </tr>
 <tr bgcolor="#ECF5FF">
      <td height="22" align="center" class="tr_southidc">优点：</td>
      <td colspan="2" width="80%">
<textarea id="pingjiid" name="pingji"  style="width:700px;height:500px;visibility:hidden;"></textarea>
