...
Set NewsRs=Conn.execute("select * from News Where ID="&ID)
If NewsRs.Eof then
...
%>    </select></td>
    ...
    <tr bgcolor="#ECF5FF">
      ...
      <td colspan="2"><input name="Author" type="text" id="auther" value="<%=NewsRs("Author")%>">
    ...
    <tr bgcolor="#ECF5FF">
      ...
      <td colspan="2"><input name="ComeFrom" type="text" id="ComeFrom" value="<%=NewsRs("ComeFrom")%>">
        <span class="TableRow1">
