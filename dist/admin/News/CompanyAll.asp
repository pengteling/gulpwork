...
sql = "select cateid,catename,followid,depth,sonid,parentid,orderID,cateType,isHome from category where 1=1 "&sql_sonid&" and modeltype<10  order by depth,orderID"
...
if  data(3,i)=1  then '一级分类 和 有下级栏目的 分类显示 +号图标  or instr(data(4,i),",")>0
				...
				class_list=class_list&"<img src=""../Images/tree_folder"&imgno&".gif"" width=""19"" height=""18"" align=""absbottom""><b>"&data(1,i)&"</b> ("&data(6,i)&")</td>"
					...
					case 3
					catetype= "单链接"
				catetype_str="<a href=""company.asp?ID="&data(0,i)&""">修改调用内容</a>"
					end select
